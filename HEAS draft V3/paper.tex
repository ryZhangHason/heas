...
(steps\,=\,1,000, n\_eval\,=\,5 episodes per genome evaluation, pop\,=\,30, ngen\,=\,15, $n\!=\!20$ runs).
...
(mean $\Delta\!=\!+0.88$ biomass, $p\!<\!0.001$, $d\!=\!0.024$). The
negligible effect size reflects short evaluation episodes (150 steps) where
both policies produce similar terminal biomass; the consistent win direction
across all 16 scenarios is the meaningful generalization signal.
...
ngen\,=\,25, $n\!=\!30$ runs): Random\,=\,14.35 (std\,0.61),
NSGA-II\,=\,10.36 (std\,4.07), Simple\,=\,9.14 (std\,3.68).
Random achieves the highest HV; a two-sided Wilcoxon rank-sum test confirms
the difference is significant ($p\!=\!7.99\!\times\!10^{-6}$,
Random\,$>$\,NSGA-II). The Wolf-Sheep Pareto front consists of a narrow band
of sustainable harvest-grazing combinations; within this concentrated
geometry, exhaustive random exploration dominates NSGA-II's
...
HV\,=\,5.565\,$\times\!10^6$ (std\,69,624; CI\,narrow at $\pm\,1.2\%$).
The enterprise Pareto front is unimodal---high-subsidy, moderate-audit-intensity
policies dominate across scenarios---producing stable optimization outcomes
with low between-run variance. The narrow CI ($\pm$1.2\%) contrasts with the
ecological case ($\pm$26\%), illustrating how domain structure shapes
reproducibility independently of framework configuration.
